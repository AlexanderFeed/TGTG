    ...
    <template v-if="!isAuthenticated">
      ...
      <section class="guest-offers page-section">
        <div class="container">
          <div class="section-heading">
            ...
            <NuxtLink class="text-link" to="/">Весь каталог <ArrowRight :size="17" /></NuxtLink>
          </div>
      ...
      <footer class="guest-footer">
        <div class="container guest-footer__inner">
          ...
          <div><NuxtLink to="/">Каталог</NuxtLink><NuxtLink to="/login">Войти</NuxtLink></div>
        </div>
      </footer>
    </template>
    ...
    <template v-else>
      ...
      <section class="container member-content">
        <div class="member-search">
          <Search :size="20" />
          <input aria-label="Поиск" placeholder="Найти кафе, магазин или блюдо..." @focus="navigateTo('/')">
          <NuxtLink class="button button--primary" to="/">Найти</NuxtLink>
        </div>
        ...
        <div class="section-heading member-offers-heading">
          ...
          <NuxtLink class="text-link" :to="`/?category=${selectedCategory}`">Показать всё <ArrowRight :size="17" /></NuxtLink>
        </div>
